    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-sm-12">
            <h3 class="text-danger">Are you sure you want to delete "<span id="casestudy-title">{{$casestudy->title ?: "this case study"}}</span>"?</h4>
            <p>
          ...
          <div class="col-sm-12">
            ...
            {!! Form::open(['action'=>['CaseStudyController@destroy', $casestudy], 'method' => 'delete', 'class'=>'form-horizontal']) !!}
              <div class="row">
